...
public class XMLBuilder {
	...
	public Document getListDoc(Collection<? extends RData> elements, String name, Mod mod) {
	...
	public Document getResourceDoc(Collection<? extends RData> elements, String name, Mod mod) {
	...
	private class IDComparator implements Comparator<RData> {
