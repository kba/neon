...
public class ModFiler {
	...
	private void saveMaps() {
		for(String name : files.listFiles(store.getActive().getPath(), "maps")) {
	...
	private void saveQuests() {
		for(String name : files.listFiles(store.getActive().getPath(), "quests")) {
	...
	private void saveScripts() {
		for(String name : files.listFiles(store.getActive().getPath(), "scripts")) {
	...
	private void saveFile(String text, String... file) {
		...
		fullPath[0] = store.getActive().getPath();
