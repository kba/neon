...
public class ArmorEditor extends ObjectEditor {
	...
	private Vector<Slot> loadSlots() {
		...
		slots.add(Slot.PAULDRON_LEFT);
		slots.add(Slot.PAULDRON_RIGHT);
		slots.add(Slot.BRACER_LEFT);
		slots.add(Slot.BRACER_RIGHT);
		slots.add(Slot.GAUNTLET_LEFT);
		slots.add(Slot.GAUNTLET_RIGHT);
