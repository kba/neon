...
public enum Slot {
	// armor
	HELMET(0.1f), PAULDRON_LEFT(0.05f), PAULDRON_RIGHT(0.05f), BRACER_LEFT(0.05f), 
	BRACER_RIGHT(0.05f), GAUNTLET_LEFT(0.05f), GAUNTLET_RIGHT(0.05f), CUIRASS(0.4f), 
	CHAUSSES(0.1f), BOOTS(0.1f), SHIELD(0.2f),
